...
var _task1Js = require("./task-1.js");
var _task2Js = require("./task-2.js");

},{"./task-1.js":"cMFNo","./task-2.js":"1EWHj"}],"cMFNo":[function(require,module,exports,__globalThis) {
...
const randomDelay = (value)=>{
    ...
    return new Promise((resolve)=>{
        setTimeout(()=>{
            resolve(`${value} (\u{437}\u{430}\u{442}\u{440}\u{438}\u{43C}\u{43A}\u{430}: ${delay}\u{43C}\u{441})`);
        }, delay);
    });
};
const promises = [
...
Promise.race(promises).then((result)=>{
    console.log(`\u{41D}\u{430}\u{439}\u{448}\u{432}\u{438}\u{434}\u{448}\u{438}\u{439} \u{43F}\u{440}\u{43E}\u{43C}\u{456}\u{441}: ${result}`);
});

},{}]},["6DHTQ","6kb64"], "6kb64", "parcelRequired71b", {})

//# sourceMappingURL=HW-80-.6528c13b.js.map
